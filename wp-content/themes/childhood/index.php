                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span>Не нашли то, что искали?</span> <?php the_field('contact_field', 2); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('title_history_1', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('history_1', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <?php
                            $img = get_field('history_img_1', 2);
                            if(!empty($img)): ?>
                            <img src="<?php echo $img['url'] ?>" 
                                alt="<?php echo $img['alt'] ?>"
                                class="aboutus__img"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('title_history_2', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('history_2', 2); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('title_history_3', 2); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('history_3', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <?php
                            $img = get_field('history_img_3', 2);
                            if(!empty($img)): ?>
                            <img src="<?php echo $img['url'] ?>" 
                                alt="<?php echo $img['alt'] ?>"
                                class="aboutus__img"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            <?php the_field('map_text', 2); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="contacts__map">
                        <?php
                           echo do_shortcode(get_field('map'));
                        ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class='contacts__feed'>
                            <?php
                            echo do_shortcode('[contact-form-7 id="143" title="Форма отзывов"]');
                            ?>
                        </div>
                    </div>
                </div>
