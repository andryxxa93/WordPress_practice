<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php
                  echo do_shortcode('[contact-form-7 id="144" title="Форма отправки вопроса"]');
                ?>
            </div>
        </div>
        <footer>
        ...
        <?php
            wp_footer();
        ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDDhjgu_2OuKuoPH3FtinGDZHemIL5Z94A"></script>
